...
const TestimonialCarousel = ({ data }) => {
  ...
  return (
    <div className="relative mt-10 max-w-full group">
      ...
      <button 
        onClick={scrollLeft}
        className="absolute -left-4 md:-left-6 top-1/2 -translate-y-1/2 z-10 bg-white border border-gray-200 rounded-full w-10 h-10 flex items-center justify-center shadow-lg hover:bg-gray-50 hover:shadow-xl transition-all opacity-0 group-hover:opacity-100 focus:opacity-100"
        aria-label="Previous"
      >
      ...
      <button 
        onClick={scrollRight}
        className="absolute -right-4 md:-right-6 top-1/2 -translate-y-1/2 z-10 bg-white border border-gray-200 rounded-full w-10 h-10 flex items-center justify-center shadow-lg hover:bg-gray-50 hover:shadow-xl transition-all opacity-0 group-hover:opacity-100 focus:opacity-100"
        aria-label="Next"
      >
